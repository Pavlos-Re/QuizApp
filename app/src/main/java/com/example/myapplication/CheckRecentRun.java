...
public class CheckRecentRun extends Service {
    ...
    private final static String TAG = "CheckRecentRun";
    private static Long MILLISECS_PER_DAY = 86400000L;
    private static Long MILLISECS_PER_MIN = 60000L;

    private static long delay = MILLISECS_PER_MIN;   // 3 minutes (for testing)
   // private static long delay = MILLISECS_PER_DAY;   // 3 days
